...
function nonExistentSupplier(search_name) {
    ...
    cy.get("#stibo_stackpanel_Supplier_Name_Search").click({force:true})
    cy.wait(2000)
    cy.get("body > div:nth-child(10) > div:nth-child(2) > div > div.main-area-root > div:nth-child(4) > div > div.left-panel > div > div:nth-child(2) > div > div:nth-child(8) > div > div:nth-child(2) > div > div > table > tbody > tr:nth-child(1) > td > table > tbody > tr:nth-child(2) > td > input").clear().type(search_name)
    cy.wait(2000)
    ...
    cy.get("body > div:nth-child(10) > div:nth-child(2) > div > div.main-area-root > div:nth-child(4) > div > div.left-panel > div > div:nth-child(2) > div > div:nth-child(8) > div > div:nth-child(2) > div > div > table > tbody > tr:nth-child(1) > td > table > tbody > tr:nth-child(2) > td > input").clear().type(search_name)
    cy.wait(2000)
    cy.get("body > div:nth-child(10) > div:nth-child(2) > div > div.main-area-root > div:nth-child(4) > div > div.left-panel > div > div:nth-child(2) > div > div:nth-child(8) > div > div:nth-child(2) > div > div > div > button.button-secondary.SearchButton > div > span").click()
    cy.wait(2000)
